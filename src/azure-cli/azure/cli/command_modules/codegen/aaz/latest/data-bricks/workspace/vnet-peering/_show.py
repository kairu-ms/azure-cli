...
@register_command(
    "data-bricks workspace vnet-peering show",
)
class Show(AAZCommand):
    """Show the vnet peering.

    :example: Show the vnet peering.
        az data-bricks workspace vnet-peering show --resource-group MyResourceGroup --workspace-name MyWorkspace -n MyPeering
    """
