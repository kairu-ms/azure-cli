...
@register_command(
    "data-bricks workspace vnet-peering create",
)
class Create(AAZCommand):
    """Create a vnet peering for a workspace.

    :example: Create a vnet peering for a workspace
        az data-bricks workspace vnet-peering create --resource-group MyResourceGroup --workspace-name MyWorkspace -n MyPeering --remote-vnet /subscriptions/000000-0000-0000/resourceGroups/MyRG/providers/Microsoft.Network/virtualNetworks/MyVNet
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.allow_forwarded_traffic = AAZBoolArg(
            ...
            arg_group="VirtualNetworkPeeringParameters",
