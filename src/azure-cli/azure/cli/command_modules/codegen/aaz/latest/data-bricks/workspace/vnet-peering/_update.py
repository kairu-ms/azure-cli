...
@register_command(
    "data-bricks workspace vnet-peering update",
)
class Update(AAZCommand):
    """Update the vnet peering.

    :example: Update the vnet peering (enable gateway transit and disable virtual network access).
        az data-bricks workspace vnet-peering update --resource-group MyResourceGroup --workspace-name MyWorkspace -n MyPeering --allow-gateway-transit --allow-virtual-network-access false
    """
