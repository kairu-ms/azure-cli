...
@register_command(
    "data-bricks workspace vnet-peering delete",
)
class Delete(AAZCommand):
    """Delete the vnet peering.

    :example: Delete the vnet peering.
        az data-bricks workspace vnet-peering delete --resource-group MyResourceGroup --workspace-name MyWorkspace -n MyPeering
    """
